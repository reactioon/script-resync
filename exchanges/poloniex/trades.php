<?php
    ...
    class trades implements koinsTrades {
        ...
        public function getTrades($arraySymbols, $exchange) {
            ...
            // $lastFiveMinutes = date("Y-m-d H:i:s",$currentDate-(60*5));
            ...
            foreach($arraySymbols as $k => $v) {
                ...
                if (!file_exists($lockFile)) {
                    ...
                    $uriPath = "https://poloniex.com/public?command=returnTradeHistory&currencyPair=$symbol";
                    $arrayData = $this->koin->requestJSON($uriPath);
                    ...
                    if (!empty($arrayData)) {
                        ...
                        foreach($arrayData as $k2 => $v2) {
                            ...
                            if (!in_array($v2["tradeID"], $arrayIds[$timestamp])) {
